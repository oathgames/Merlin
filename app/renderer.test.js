...
test('Truesight WoW — growth header leads with Reach + Mindshare + List Growth', () => {
  ...
  assert.ok(fn.includes("label: 'List Growth'") && fn.includes('byKey.joined_list'),
    'List Growth tile is the joined_list stage');
